import{_ as l,c as p,b as e,d as i,a as n,e as t,r as d,o as r}from"./app-CV4iLaoC.js";const h={};function o(c,s){const a=d("Tikz");return r(),p("div",null,[s[0]||(s[0]=e(`<h1 id="简介" tabindex="-1">简介</h1><h2 id="环境配置" tabindex="-1">环境配置</h2><p>代码类型: tikz</p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code class="language-"><span class="line"><span>\\usepackage{tikz}</span></span>
